...
export default function DataContributorSearch() {
  return (
    <Container className="w-11/12 max-w-container mb-10 md:mb-20">
      <FlexBox className="w-full flex-col relative h-full items-center rounded-t-card rounded-bl-card bg-gray125 md:bg-white pt-8 md:pt-0 z-20">
        <img
          draggable={false}
          src="/assets/img/home/home-2/dataContributorSearch/bg.png"
          alt=""
          className="hidden md:block"
        />

        <FlexBox className="flex-col w-full items-center text-blue400 flex md:absolute top-10 lg:top-20 left-1/2 -translate-x-0 md:-translate-x-1/2 gap-5 2xl:gap-8">
          <Typography className="text-center w-11/12 lg:w-4/5 text-2xl sm:text-3xl lg:text-4xl 2xl:text-5xl 3xl:text-6xl font-aeonik-bold">
            Is Your Data Contributor allowing your data to be shared with third
            parties?
          </Typography>
          <InputBase
        ...
        <img
          draggable={false}
          src="/assets/img/home/home-2/dataContributorSearch/bg-mobile.png"
          alt=""
